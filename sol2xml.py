...
if len(argv)<3:
    ...
    if argvSw=='-x':
        ...
        try:
            ...
            print 'Could Not Open The Input File: '+argvInpFile else:
            def num2x():
            ...
            try:
                ...
                solxroot.setAttribute('std_version','0.76')
...
#                 print 'Converted File: '+argvOutFile+' Was Successfully Created.'
        ...
        try:
            ...
            print 'Error At Parsing XML File Input.' else:
            def x2num():
                ...
                if sValue=='Infinity':
                    ...
                    sData+='\x7F\xF8\x00\x00\x00\x00\x00\x00' else:
                    nValue=float(sValue)
                    sData+=pack('>d',nValue)
            def x2bol():
                global sData,sLenVname,sVname,c
            ...
            try:
                solxroot=d.firstChild
                if solxroot.tagName!='solx' or float(solxroot.getAttribute('std_version'))>0.76:
